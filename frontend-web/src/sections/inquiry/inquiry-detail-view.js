  ...
  useEffect(() => {
    async function fetchAttachments() {
      ...
      try {
        ...
        // senderName, senderEmail을 senderType/senderInfo 기반으로 동적으로 할당
        currentInquiry.senderName =
          currentInquiry.senderType === "seller"
            ? currentInquiry.senderInfo?.name
            : currentInquiry.senderInfo?.user_name || "";
        currentInquiry.senderEmail = currentInquiry.senderInfo?.email || "";
      } catch (err) {
